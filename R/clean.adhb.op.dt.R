##' Takes ADHB operations from provided wide format to long format by Event ID.
##'
##' .. content for \details{} ..
##'
##' @title
...
clean.adhb.op.dt <- function(adhb.event.op.patient.dt) {
  
  
  adhb.op.dt = adhb.event.op.patient.dt[,
                                            c(
                                              "Theatre Event ID",
                                              "Event ID",
                                              "Proc 1 Code",
